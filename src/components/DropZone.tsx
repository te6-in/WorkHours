			...
			<AnimatePresence>
				{isDragActive && (
					<motion.div
						...
						className="fixed top-0 left-0 flex h-screen w-screen flex-col items-center justify-center gap-6 bg-slate-200 bg-opacity-40 text-slate-900 backdrop-blur-md"
					>
						<svg
